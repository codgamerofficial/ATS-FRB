          ...
          {examples.map((example, index) => (
            ...
            >
              <SciFiCard className="overflow-hidden hover:shadow-cyan-500/20 transition-all duration-300">
                <div className="h-64 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 flex items-center justify-center border-b border-cyan-500/20">
                  <div className="text-center p-6">
                    <div className="w-16 h-16 bg-cyan-500/30 border border-cyan-400 rounded-full mx-auto mb-4 flex items-center justify-center text-cyan-400 font-bold text-xl">
                      {example.name.charAt(0)}
                    </div>
                    <h3 className="font-bold text-white">{example.name}</h3>
                    <p className="text-sm text-gray-300">{example.role}</p>
                  </div>
                </div>
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-sm text-gray-400">{example.downloads} downloads</span>
                  </div>
